# -*- coding: utf-8 -*-
"""
Created on Wed Nov  2 18:07:23 2016
...
def GetTest(offline_test_data):
    return offline_test_data[['user','merchant','coupon','discount','distance','weekday','u_r','m_r','c_r']].values
...
def GetTrain(offline_train_data,way = 'add'):
    if way == 'add':
        ...
        print 'Wrong Input'
    X = offline_train_data[['user','merchant','coupon','discount','distance','weekday','u_r','m_r','c_r']].values
